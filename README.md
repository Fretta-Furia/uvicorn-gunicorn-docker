[![Test](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/workflows/Test/badge.svg)](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/actions?query=workflow%3ATest) [![Deploy](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/workflows/Deploy/badge.svg)](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/actions?query=workflow%3ADeploy)

## Supported tags and respective `Dockerfile` links

* [`python3.8`, `latest` _(Dockerfile)_](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/blob/master/docker-images/python3.8.dockerfile)
* [`python3.7`, _(Dockerfile)_](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/blob/master/docker-images/python3.7.dockerfile)
* [`python3.6` _(Dockerfile)_](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/blob/master/docker-images/python3.6.dockerfile)
* [`python3.8-slim` _(Dockerfile)_](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/blob/master/docker-images/python3.8-slim.dockerfile)
* [`python3.8-alpine3.10` _(Dockerfile)_](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/blob/master/docker-images/python3.8-alpine3.10.dockerfile)
* [`python3.7-alpine3.8` _(Dockerfile)_](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/blob/master/docker-images/python3.7-alpine3.8.dockerfile)
* [`python3.6-alpine3.8` _(Dockerfile)_](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/blob/master/docker-images/python3.6-alpine3.8.dockerfile)

**Note**: Note: There are [tags for each build date](https://hub.docker.com/r/ghcr.io/fretta-furia/uvicorn-gunicorn/tags). If you need to "pin" the Docker image version you use, you can select one of those tags. E.g. `ghcr.io/fretta-furia/uvicorn-gunicorn:python3.7-2019-10-15`.
...
**GitHub repo**: [https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker)

**Docker Hub image**: [https://hub.docker.com/r/ghcr.io/fretta-furia/uvicorn-gunicorn/](https://hub.docker.com/r/ghcr.io/fretta-furia/uvicorn-gunicorn/)
...
### `ghcr.io/fretta-furia/uvicorn-gunicorn`
...
* [**ghcr.io/fretta-furia/uvicorn-gunicorn-starlette**](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-starlette-docker)
* [**ghcr.io/fretta-furia/uvicorn-gunicorn-fastapi**](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-fastapi-docker)

But could be used as the base image to run any Python web application that uses the ASGI specification.

If you are creating a new [**Starlette**](https://www.starlette.io/) web application you should use [**ghcr.io/fretta-furia/uvicorn-gunicorn-starlette**](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-starlette-docker) instead.

If you are creating a new [**FastAPI**](https://fastapi.tiangolo.com/) web application you should use [**ghcr.io/fretta-furia/uvicorn-gunicorn-fastapi**](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-fastapi-docker) instead.
...
**Note**: Unless you are doing something more technically advanced, you probably should be using [**Starlette**](https://www.starlette.io/) with [**ghcr.io/fretta-furia/uvicorn-gunicorn-starlette**](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-starlette-docker) or [**FastAPI**](https://fastapi.tiangolo.com/) with [**ghcr.io/fretta-furia/uvicorn-gunicorn-fastapi**](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-fastapi-docker).
...
```Dockerfile
FROM ghcr.io/fretta-furia/uvicorn-gunicorn:python3.7
...
You can use the [config file](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/blob/master/docker-images/gunicorn_conf.py) from this image as a starting point for yours.
...
* 🔥 Remove unused Travis and old GitHub Actions configs. PR [#56](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/56) by [@tiangolo](https://github.com/tiangolo).
* ✏️ Fix typo (type annotation) in tests. PR [#55](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/55) by [@tiangolo](https://github.com/tiangolo).
* 👷 Add GitHub Action latest-changes, update issue-manager, add funding. PR [#53](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/53) by [@tiangolo](https://github.com/tiangolo).
* ⬆️ Install uvicorn[standard] to include uvloop and Gunicorn support. PR [#54](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/54) by [@tiangolo](https://github.com/tiangolo).
### 0.6.0

* Add docs about installing and pinning dependencies. PR [#41](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/41).
* Add `slim` version. PR [#40](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/40).
* Remove leftover unneeded config for tests. PR [#39](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/39).
* Add extra configs, tests, and docs for:
    ...
    * `GUNICORN_CMD_ARGS`
    * `MAX_WORKERS`
    * PR [#38](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/38)
* Set up CI using GitHub actions, they provide more free instances, so builds finish faster (4 min vs 9 min). PR [#37](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/37).
* Add support for Python 3.8. PR [#36](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/36).
* Refactor tests to remove custom testing Dockerfiles, generate them during tests. PR [#35](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/35).
* Refactor and simplify build process to reduce code duplication. PR [#34](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/34).
* Disable `pip` cache during installation with `--no-cache-dir`. PR [#13](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/13) by [@pmav99](https://github.com/pmav99).
* Migrate local development from Pipenv to Poetry. PR [#31](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/31).
* Add tests and docs for custom `PRE_START_PATH` env var. PR [#30](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/30).
* Add support for custom `PRE_START_PATH` env var. PR [#12](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/12) by [@mgfinch](https://github.com/mgfinch).

### 0.5.0

* Refactor tests to use env vars and add image tags for each build date, like `ghcr.io/fretta-furia/uvicorn-gunicorn:python3.7-2019-10-15`. PR [#15](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/15).
* Update Gunicorn worker heartbeat directory to `/dev/shm` to improve performance. PR [#9](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/9) by [@wshayes](https://github.com/wshayes).
* Upgrade Travis. PR [#7](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/7).

### 0.4.0

* Add support for live auto-reload with an additional custom script `/start-reload.sh`, check the [updated documentation](https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker#development-live-reload). PR <a href="https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/6" target="_blank">#6</a>.

### 0.3.0

* Set `WORKERS_PER_CORE` by default to `1`, as it shows to have the best performance on benchmarks.
* Make the default web concurrency, when `WEB_CONCURRENCY` is not set, to a minimum of 2 workers. This is to avoid bad performance and blocking applications (server application) on small machines (server machine/cloud/etc). This can be overridden using `WEB_CONCURRENCY`. This applies for example in the case where `WORKERS_PER_CORE` is set to `1` (the default) and the server has only 1 CPU core. PR <a href="https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/5" target="_blank">#5</a>.

### 0.2.0

* Make `/start.sh` run independently, reading and generating used default environment variables. And remove `/entrypoint.sh` as it doesn't modify anything in the system, only reads environment variables. PR <a href="https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-docker/pull/4" target="_blank">#4</a>.

### 0.1.2

* Whenever this image is built (and each of its tags/versions), trigger a build for the children images (<a href="https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-fastapi-docker" target="_blank">FastAPI</a> and <a href="https://github.com/ghcr.io/fretta-furia/uvicorn-gunicorn-starlette-docker" target="_blank">Starlette</a>).
